...
namespace Server.Persistence.Contexts
{
  public class AppDbContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      CreateTablePurchaseProduct(builder);
      base.OnModelCreating(builder);
    }

    private static void CreateTablePurchaseProduct(ModelBuilder builder)
    {
      var entity = builder.Entity<PurchaseProduct>();
      entity.ToTable("PurchaseProducts");

      entity.HasKey(pp => new { pp.ProductId, pp.PurchaseId });
